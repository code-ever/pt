...
import germanimage from '../../images/germans/aus.jpg'
  ...
  return (
      <div className=''>
          <div className='py-10 mt-10 w-full'>
              <img src={germanimage} alt='image' className='w-full h-[300px] object-cover ' />
          </div>
